...
/**
 * Widen the code_sequences.label CHECK constraint for Sprint 5's new
 * numbered documents (discharge summary, death certificate, ER visit) —
 * same pattern as add_ipd_labels_to_code_sequences_label_enum.php.
 */
