...
class LabOrderStatusEnum extends BaseEnum
{
    ...
    public static $allowedTransitions = [
        self::ORDERED          => [self::SAMPLE_COLLECTED, self::CANCELLED],
        self::SAMPLE_COLLECTED => [self::IN_PROGRESS, self::CANCELLED],
        self::IN_PROGRESS      => [self::VERIFIED, self::CANCELLED],
        self::VERIFIED         => [self::REPORTED],
        self::REPORTED         => [],
        self::CANCELLED        => [],
    ];
