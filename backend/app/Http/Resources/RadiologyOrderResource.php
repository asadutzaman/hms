...
class RadiologyOrderResource extends BaseResource
{
    public function toArray($request)
    {
        try {
            ...
            $data = [
                'id'                   => $this->id,
                'uuid'                 => $this->uuid,
                'rad_order_no'         => $this->rad_order_no,
                ...
                'order_status'         => $status,
                'order_status_label'   => RadOrderStatusEnum::label($status),
            ...
            if ($resource->relationLoaded('items')) {
                $data['items'] = RadiologyOrderItemResource::collection($resource->items)->toArray($request);
            }
