...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/requisition`
const endpoints = {
  ...
  acknowledge: (id: Number) => `${RESOURCE_ENDPOINT}/acknowledge/${id}`,
...
export default class RequisitionApi {
  ...
  public acknowledge = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.acknowledge(id)
    return HttpService.put(url, payload, params, headers)
  }
