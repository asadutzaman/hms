...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/purchase-order`
const endpoints = {
  ...
  itemsForGrn: (id: any) => `${RESOURCE_ENDPOINT}/${id}/items-for-grn`,
}
...
export default class PurchaseOrderApi {
  ...
  public itemsForGrn = (id: any, params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.itemsForGrn(id)
    return HttpService.get(url, params, headers)
  }
}
