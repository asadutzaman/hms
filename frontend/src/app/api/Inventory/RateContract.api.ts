...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/rate-contract`
const endpoints = {
...
export default class RateContractApi {
  ...
  public submit = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.submit(id)
    return HttpService.post(url, payload, params, headers)
  }

  public approve = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.approve(id)
    return HttpService.post(url, payload, params, headers)
  }

  public reject = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.reject(id)
    return HttpService.post(url, payload, params, headers)
  }
}
