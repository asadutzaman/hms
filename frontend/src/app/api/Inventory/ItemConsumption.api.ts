...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/item-consumption`
const endpoints = {
    ...
    updateProcessStatus: (id: Number) => `${RESOURCE_ENDPOINT}/update-process-status/${id}`,
    ...
    getBranchItemStock: () => `${RESOURCE_ENDPOINT}/branch-item-stock`,
}

export default class ItemConsumptionApi {
    ...
    public updateProcessStatus = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> => {
        const url = endpoints.updateProcessStatus(id);
        return HttpService.put(url, payload, params, headers);
    }
    ...
    public export = (fileType = "", params = {}, headers = {}): AxiosPromise<any> => {
        const url = endpoints.export(fileType);
        return HttpService.exportFile(url, params, headers);
    };

    public getBranchItemStock = (params = {}, headers = {}): AxiosPromise<any> => {
        const url = endpoints.getBranchItemStock();
        return HttpService.get(url, params, headers);
    };
