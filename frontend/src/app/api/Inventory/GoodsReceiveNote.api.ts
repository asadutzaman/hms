...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/goods-receive-note`
const endpoints = {
  ...
  getItemGrnDetails: () => `${RESOURCE_ENDPOINT}/item-grn-details`,
}

export default class GoodsReceiveNoteApi {
  ...
  // Item Wise Grn Details
  public getItemGrnDetails = (params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.getItemGrnDetails()
    return HttpService.get(url, params, headers)
  }
}
