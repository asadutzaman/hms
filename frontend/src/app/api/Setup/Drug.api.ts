...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/drug`
const endpoints = {
    ...
    generics: () => `${RESOURCE_ENDPOINT}/generics`,
    substitutes: (id: any) => `${RESOURCE_ENDPOINT}/${id}/substitutes`,
    stock: (id: any) => `${RESOURCE_ENDPOINT}/${id}/stock`,
}
...
export default class DrugApi {
    ...
    public generics = (params = {}, headers = {}): AxiosPromise<any> => {
        const url = endpoints.generics();
        return HttpService.get(url, params, headers);
    };

    public substitutes = (id: any, params = {}, headers = {}): AxiosPromise<any> => {
        const url = endpoints.substitutes(id);
        return HttpService.get(url, params, headers);
    };

    public stock = (id: any, params = {}, headers = {}): AxiosPromise<any> => {
        const url = endpoints.stock(id);
        return HttpService.get(url, params, headers);
    };
}
