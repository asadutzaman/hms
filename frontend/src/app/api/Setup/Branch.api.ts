...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/branch`
const endpoints = {
  ...
  getBranchTree: () => `${RESOURCE_ENDPOINT}/getBranchTree`,
...
export default class BranchApi {
  ...
  public getBranchTree = (params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.getBranchTree()
    return HttpService.get(url, params, headers)
  }
