...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/insurance-scheme`
...
const endpoints = {
    ...
    byCompany: (insuranceCompanyId: any) => `${RESOURCE_ENDPOINT}/by-company/${insuranceCompanyId}`,
}

export default class InsuranceSchemeApi {
    ...
    public byCompany = (insuranceCompanyId: any): AxiosPromise<any> =>
        HttpService.get(endpoints.byCompany(insuranceCompanyId))
}
