...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/bed`
const endpoints = {
...
export default class BedApi {
  ...
  public dashboard = (params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.dashboard()
    return HttpService.get(url, params, headers)
  }

  public board = (params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.board()
    return HttpService.get(url, params, headers)
  }
}
