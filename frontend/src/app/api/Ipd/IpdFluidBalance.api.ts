...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/ipd-fluid-balance`
const endpoints = {
  ...
  summary: (admissionId: any) => `${RESOURCE_ENDPOINT}/summary/${admissionId}`,
}

export default class IpdFluidBalanceApi {
  ...
  public summary = (admissionId: any, params = {}, headers = {}): AxiosPromise<any> =>
    HttpService.get(endpoints.summary(admissionId), params, headers)
}
