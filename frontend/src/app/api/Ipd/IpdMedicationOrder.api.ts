...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/ipd-medication-order`
const endpoints = {
  ...
  discontinue: (id: any) => `${RESOURCE_ENDPOINT}/${id}/discontinue`,
  administerPrn: (id: any) => `${RESOURCE_ENDPOINT}/${id}/administer-prn`,
}

export default class IpdMedicationOrderApi {
  ...
  public discontinue = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> =>
    HttpService.post(endpoints.discontinue(id), payload, params, headers)
  public administerPrn = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> =>
    HttpService.post(endpoints.administerPrn(id), payload, params, headers)
}
