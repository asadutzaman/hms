...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/ipd-advance-payment`
const endpoints = {
  ...
  apply: (id: any) => `${RESOURCE_ENDPOINT}/${id}/apply`,
}

export default class IpdAdvancePaymentApi {
  ...
  public apply = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> =>
    HttpService.post(endpoints.apply(id), payload, params, headers)
}
