...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/prescription-template`
...
export default class PrescriptionTemplateApi {
    ...
    public apply = (id: any): AxiosPromise<any> =>
        HttpService.get(endpoints.apply(id))
}
