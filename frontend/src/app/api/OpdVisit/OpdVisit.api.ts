...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/opd-visit`
...
export default class OpdVisitApi {
  ...
  public today = (params = {}, headers = {}): AxiosPromise<any> =>
    HttpService.get(endpoints.today(), params, headers)

  public transition = (id: any, payload = {}, params = {}, headers = {}): AxiosPromise<any> =>
    HttpService.post(endpoints.transition(id), payload, params, headers)
