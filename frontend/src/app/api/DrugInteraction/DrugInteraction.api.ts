...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/drug-interaction`
...
const endpoints = {
    ...
    check: () => `${RESOURCE_ENDPOINT}/check`,
}

export default class DrugInteractionApi {
    ...
    public check = (payload: {drug_ids: any[]; patient_id?: any}): AxiosPromise<any> =>
        HttpService.post(endpoints.check(), payload)
}
