...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/organogram`
const endpoints = {
    ...
    getOrganogramTree: () => `${RESOURCE_ENDPOINT}/getOrganogramTree`,
    syncDoptarOrganogram: () => `${RESOURCE_ENDPOINT}/syncDoptarOrganogram`,
}

export default class OrganogramApi {
    public list = (params = {}, headers = {}): AxiosPromise<any> => {
        const url = endpoints.list();
        return HttpService.get(url, params, headers);
    }

    public getOrganogramTree = (): AxiosPromise<any> => {
        const url = endpoints.getOrganogramTree();
    ...
    public syncDoptarOrganogram = (params = {}, headers = {}): AxiosPromise<any> => {
        const url = endpoints.syncDoptarOrganogram();
        return HttpService.get(url, params, headers);
    }
}