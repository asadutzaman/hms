...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/workflow-step`
const endpoints = {
  list: () => `${RESOURCE_ENDPOINT}`,
  getById: (id: any) => `${RESOURCE_ENDPOINT}/${id}`,
  getByWhere: (params: any) => `${RESOURCE_ENDPOINT}/getByWhere`,
...
export default class WorkflowStepApi {
  ...
  public getByWhere = (params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.getByWhere(params)
    return HttpService.get(url, params, headers)
  }
