...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/organization`
const endpoints = {
    ...
    getOrganizationTree: () => `${RESOURCE_ENDPOINT}/getOrganizationTree`,
}
...
export default class OrganizationApi {
    ...
    public getOrganizationTree = (): AxiosPromise<any> => {
        const url = endpoints.getOrganizationTree();
