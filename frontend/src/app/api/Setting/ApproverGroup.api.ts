...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/approver-group`
const endpoints = {
  ...
  memberDropdown: () => `${RESOURCE_ENDPOINT}/member-dropdown`,
}
...
export default class UnitApi {
  ...
  public memberDropdown = (params = {}, headers = {}): AxiosPromise<any> => {
    const url = endpoints.memberDropdown()
    return HttpService.get(url, params, headers)
  }
}
