...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/icd10-code`
...
const endpoints = {
    ...
    search: () => `${RESOURCE_ENDPOINT}/search`,
}

export default class Icd10CodeApi {
    ...
    public search = (q: string): AxiosPromise<any> =>
        HttpService.get(endpoints.search(), {q})
}
