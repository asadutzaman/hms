...
const RESOURCE_ENDPOINT = `${CONSTANT_CONFIG.SERVER_PREFIX}/billing-package`
...
const endpoints = {
    ...
    updateItems: (id: any) => `${RESOURCE_ENDPOINT}/${id}/items`,
}

export default class BillingPackageApi {
    ...
    public updateItems = (id: any, payload = {}): AxiosPromise<any> =>
        HttpService.put(endpoints.updateItems(id), payload)
}
