...
import BrandListFilter from './BrandList.filter'
import BrandListing from './BrandList.listing'
import BrandListPagination from './BrandList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete brand successfully.',
    ...
    delete_bulk_confirm: 'Are you sure you wish to delete selected brand?',
  },
}

const BrandListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(BrandApi, queryState, initialState, props)
...
export default BrandListController
