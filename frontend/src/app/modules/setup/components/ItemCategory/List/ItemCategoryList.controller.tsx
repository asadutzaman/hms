...
import ItemCategoryListFilter from './ItemCategoryList.filter'
import ItemCategoryListing from './ItemCategoryList.listing'
import ItemCategoryListPagination from './ItemCategoryList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Item Category successfully.',
    delete_confirm_title: 'Delete Item Category',
    delete_confirm: 'Are you sure you want to delete this Item Category?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Item Category?',
  },
}

const ItemCategoryListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(ItemCategoryApi, queryState, initialState, props)
    ...
    <div className='card'>
      <Form form={formRef} name='exampleListingFilterForm' initialValues={initialValues}>
        ...
        <ItemCategoryListing
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <ItemCategoryListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <ItemCategoryViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <ItemCategoryFormController
        entityId={entityId}
...
export default ItemCategoryListController
