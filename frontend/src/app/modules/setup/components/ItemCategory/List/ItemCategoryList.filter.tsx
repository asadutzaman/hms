...
const ItemCategoryListFilter: FC<any> = (props) => {
  const { Search } = Input;
  const { Option } = Select;
  ...
  return (
    <div className="p-6">
      <Row gutter={[16, 16]}>
        ...
        <Col md={6} xs={12}>
          <CreateAction
            actionItem={ItemCategoryAction.COMMON_ACTION.CREATE}
...
export default React.memo(ItemCategoryListFilter);
