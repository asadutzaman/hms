...
import DesignationAddOrEditForm from './DesignationForm.form'
import {useCrudFormService} from 'src/app/hooks/crud/useCrudFormService'

const initialState = {
  modalTitle: 'Create Designation',
  itemData: {},
  fields: {
    title: null,
    grade: null,
...
const DesignationFormController: FC<any> = (props) => {
  const {
    BaseCrudFormService,
    entityId,
    modalTitle,
    ...
    handleSubmitFailed,
    handleCallbackFunc,
  } = useCrudFormService(DesignationApi, initialState, props)
  ...
  return (
    <div className='form-page-container form-page-container-example'>
      <DrawerForm
        ...
        component={DesignationAddOrEditForm}
...
export default React.memo(DesignationFormController)
