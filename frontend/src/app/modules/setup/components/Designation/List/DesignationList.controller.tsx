...
import DesignationListFilter from './DesignationList.filter'
import DesignationListing from './DesignationList.listing'
import DesignationListPagination from './DesignationList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Designation successfully.',
    delete_confirm_title: 'Delete Designation',
    delete_confirm: 'Are you sure you want to delete this Designation?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Designation?',
  },
}

const DesignationListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(DesignationApi, queryState, initialState, props)
    ...
    <div className='card'>
      <Form form={formRef} name='exampleListingFilterForm' initialValues={initialValues}>
        ...
        <DesignationListing
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <DesignationListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <DesignationFormController
        entityId={entityId}
...
export default DesignationListController
