...
import ShelveListFilter from './ShelveList.filter';
import ShelveListing from './ShelveList.listing';
import ShelveListPagination from './ShelveList.pagination';
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete shelve successfully.',
    delete_confirm_title: 'Delete Shelve',
    delete_confirm: 'Are you sure you want to delete this shelve?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected shelve?',
  },
};

const ShelveListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(ShelveApi, queryState, initialState, props);
      ...
      <div className="listing-page-container listing-page-container-resource">
        ...
        >
          ...
          <ShelveListing
            ...
            handleCallbackFunc={handleCallbackFunc}
          />
          <ShelveListPagination
            pagination={pagination}
            totalCount={totalCount}
            handleOnChanged={handleOnChanged}
          />
        </Form>
        <ShelveViewController
          entityId={entityId}
          reloadView={reloadView}
          isShowView={isShowView}
          handleCallbackFunc={handleCallbackFunc}
        />
        <ShelveFormController
          entityId={entityId}
...
export default ShelveListController;
