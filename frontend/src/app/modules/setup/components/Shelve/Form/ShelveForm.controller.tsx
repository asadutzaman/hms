...
import ShelveForm from './ShelveForm.form'

const initialState = {
  modalTitle: 'Create Shelve',
  itemData: {},
  fields: {
    type: null,
    branch_id: null,
...
const ShelveFormController: FC<any> = (props) => {
  const {
    BaseCrudFormService,
    entityId,
    modalTitle,
    ...
    handleSubmitFailed,
    handleCallbackFunc,
  } = useCrudFormService(ShelveApi, initialState, props)

  useEffect(() => {
    if (entityId && isShowForm) {
      setIsNewRecord(false)
      setModalTitle('Edit Shelve')
      resetForm()
      loadData()
    } else {
      resetForm()
...
export default React.memo(ShelveFormController)
