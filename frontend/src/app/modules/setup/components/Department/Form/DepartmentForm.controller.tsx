...
import DepartmentAddOrEditForm from './DepartmentForm.form'
...
const DepartmentFormController: FC<any> = (props) => {
  const {
    BaseCrudFormService,
    entityId,
    modalTitle,
    ...
    handleSubmitFailed,
    handleCallbackFunc,
  } = useCrudFormService(DepartmentApi, initialState, props)
  ...
  return (
    <div className='form-page-container form-page-container-example'>
      <DrawerForm
        ...
        component={DepartmentAddOrEditForm}
...
export default React.memo(DepartmentFormController)
