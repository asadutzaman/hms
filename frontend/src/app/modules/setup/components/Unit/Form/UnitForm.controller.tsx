...
import UnitAddOrEditForm from './UnitForm.form'
...
const UnitFormController: FC<any> = (props) => {
  const {
    BaseCrudFormService,
    entityId,
    modalTitle,
    ...
    handleSubmitFailed,
    handleCallbackFunc,
  } = useCrudFormService(UnitApi, initialState, props)
...
export default React.memo(UnitFormController)
