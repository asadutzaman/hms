      ...
      <div className="row mb-7">
        <div className="col-lg-12">
          <EditAction
            ...
            actionItem={UnitAction.COMMON_ACTION.EDIT}
            handleCallbackFunc={handleCallbackFunc}
          />
          <DeleteAction
            entityId={itemData.id}
            actionItem={UnitAction.COMMON_ACTION.DELETE}
            handleCallbackFunc={handleCallbackFunc}
          />
        </div>
      </div>
...
export default React.memo(UnitView);
