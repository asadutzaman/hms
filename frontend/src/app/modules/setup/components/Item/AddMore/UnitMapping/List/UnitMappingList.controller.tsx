...
import UnitMappingList from './UnitMappingList.listing';
import UnitMappingFormController from '../Form/UnitMappingForm.controller';
...
const UnitMappingListController: FC<IProps> = (props) => {
  ...
  const handleActions = (action: string, entityIndex?: any) => {
    ...
    if (action === 'add') {
      ...
      AntModal.confirm(
        'Delete UnitMapping',
        'Are you sure you want to delete this UnitMapping?',
        entityIndex,
        handleDeleteConfirm,
        'Delete'
      );
...
export default UnitMappingListController;
