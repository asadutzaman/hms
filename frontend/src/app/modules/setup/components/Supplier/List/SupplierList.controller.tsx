...
import SupplierListFilter from './SupplierList.filter';
import SupplierListing from './SupplierList.listing';
import SupplierListPagination from './SupplierList.pagination';
...
const initialState = {
  ...
  message: {
    ...
    delete_bulk_confirm: 'Are you sure you wish to delete selected Supplier?',
  },
};

const SupplierListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(SupplierApi, queryState, initialState, props);
