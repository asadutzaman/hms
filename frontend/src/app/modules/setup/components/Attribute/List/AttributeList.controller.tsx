...
import AttributeListing from './AttributeList.listing';
import AttributeListPagination from './AttributeList.pagination';
...
const initialState = {
  ...
  message: {
    ...
    delete_bulk_confirm: 'Are you sure you wish to delete selected attribute?',
  },
};

const AttributeListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(AttributeApi, queryState, initialState, props);
