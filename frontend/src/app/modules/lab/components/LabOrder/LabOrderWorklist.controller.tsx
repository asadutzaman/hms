...
import PlaceLabOrderModal from './PlaceLabOrderModal'
import LabOrderViewController from './View/LabOrderView.controller'
...
const LabOrderWorklistController: FC = () => {
  const {t} = useLang()
  ...
  return (
    <div className='card p-6'>
      <div className='d-flex justify-content-between align-items-center mb-4'>
        <h3 className='mb-0'>{t('Lab Order Worklist')}</h3>
        <div>
          <Select
            allowClear
...
export default LabOrderWorklistController
