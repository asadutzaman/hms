...
import {OpdVisitApi, PatientApi} from 'src/app/api'
...
const WalkInController: FC<any> = () => {
  ...
  const handleSubmit = async (values: any) => {
    ...
    try {
      ...
      const response: any = await OpdVisitApi.create(payload)
  ...
  return (
    <div className='card p-4'>
      ...
      <p className='text-muted'>
        Quick-register a patient who arrives without a prior visit
      </p>
      ...
      <Form form={form} layout='vertical' onFinish={handleSubmit}>
        ...
        <Space>
          ...
          <Button onClick={() => navigate('/admin/opd/list')} size='large'>
            Cancel
          </Button>
        </Space>
      </Form>
