...
import {OpdVisitApi, DepartmentApi} from 'src/app/api'
import OpdVisitListFilter from './OpdVisitList.filter'
import OpdVisitListing from './OpdVisitList.listing'
import OpdVisitListPagination from './OpdVisitList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'OpdVisit deleted successfully.',
    delete_confirm_title: 'Delete OpdVisit',
    delete_confirm: 'Are you sure you want to delete this OpdVisit?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected OpdVisits?',
  },
}

const OpdVisitListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(OpdVisitApi, queryState, initialState, props)
  ...
  const handlePayload = (): void => {
    payload.current = {
      ...
      $expand:
        'patient,doctor,department,chamber,createdBy,updatedBy,OpdVisitSlot',
  ...
  return (
    <div className='card'>
      <Form
        form={formRef}
        name='OpdVisitListingFilterForm'
      ...
      >
        ...
        <OpdVisitListing
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <OpdVisitListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <OpdVisitViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <OpdVisitFormController
        entityId={entityId}
...
export default OpdVisitListController
