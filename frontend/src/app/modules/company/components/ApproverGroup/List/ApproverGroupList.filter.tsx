...
import {
  RefreshIcon,
  ResetIcon,
} from '../../../../../../_metronic/assets/images/icon/svg';
import { useLang } from 'src/app/hooks/useLang';

const ApproverGroupListFilter: FC<any> = (props) => {
  const { Search } = Input;
  const { Option } = Select;
  ...
  return (
    <div className="p-6">
      <Row gutter={[16, 16]}>
        ...
        <Col md={6} xs={12}>
          <CreateAction
            actionItem={ApproverGroupAction.COMMON_ACTION.CREATE}
...
export default React.memo(ApproverGroupListFilter);
