...
import ApproverGroupListFilter from './ApproverGroupList.filter'
import ApproverGroupListing from './ApproverGroupList.listing'
import ApproverGroupListPagination from './ApproverGroupList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Approver Group successfully.',
    delete_confirm_title: 'Delete Approver Group',
    delete_confirm: 'Are you sure you want to delete this Approver Group?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Approver Group?',
  },
}

const ApproverGroupListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(ApproverGroupApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='exampleListingFilterForm' initialValues={initialValues}>
        <ApproverGroupListFilter
          filters={filters}
          handleOnChanged={handleOnChanged}
          handleCallbackFunc={handleCallbackFunc}
        />
        <ApproverGroupListing
          loading={loading}
          listData={listData}
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <ApproverGroupListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <ApproverGroupViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <ApproverGroupFormController
        entityId={entityId}
...
export default ApproverGroupListController
