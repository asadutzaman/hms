...
import OrganogramForm from './OrganogramForm.form'

const initialState = {
  modalTitle: 'Create Organogram',
  itemData: {},
  fields: {
...
const OrganogramFormController: FC<any> = (props) => {
  const {
    BaseCrudFormService,
    entityId,
    modalTitle,
    ...
    handleSubmitFailed,
    handleCallbackFunc,
  } = useCrudFormService(OrganogramApi, initialState, props)

  useEffect(() => {
    if (entityId && isShowForm) {
      setIsNewRecord(false)
      setModalTitle('Edit Organogram')
      resetForm()
      loadData()
    } else {
      resetForm()
...
export default React.memo(OrganogramFormController)
