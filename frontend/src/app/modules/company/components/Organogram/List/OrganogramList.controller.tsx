...
import OrganogramListFilter from './OrganogramList.filter';
import OrganogramListing from './OrganogramList.listing';
import OrganogramListPagination from './OrganogramList.pagination';
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete organogram successfully.',
    delete_confirm_title: 'Delete Organogram',
    delete_confirm: 'Are you sure you want to delete this organogram?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm:
      'Are you sure you wish to delete selected organograms?',
  },
};

const OrganogramListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(OrganogramApi, queryState, initialState, props);
      ...
      <div className="listing-page-container listing-page-container-resource">
        ...
        >
          ...
          <OrganogramListing
            ...
            handleCallbackFunc={handleCallbackFunc}
          />
          <OrganogramListPagination
            pagination={pagination}
            totalCount={totalCount}
            handleOnChanged={handleOnChanged}
          />
        </Form>
        <OrganogramViewController
          entityId={entityId}
          reloadView={reloadView}
          isShowView={isShowView}
          handleCallbackFunc={handleCallbackFunc}
        />
        <OrganogramFormController
          entityId={entityId}
...
export default OrganogramListController;
