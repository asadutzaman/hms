...
import AddOrEditForm from './SendSmsAddMoreItemForm.form'
...
const SendSmsAddMoreItemFormModal: FC<IProps> = (props) => {
...
export default React.memo(SendSmsAddMoreItemFormModal)
