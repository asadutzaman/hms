...
import AddOrEditForm from './UserActionAddMoreItemForm.form'
...
const UserActionAddMoreItemFormModal: FC<IProps> = (props) => {
...
export default React.memo(UserActionAddMoreItemFormModal)
