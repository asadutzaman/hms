...
import AddOrEditForm from "./ApproverAddMoreItemForm.form";
...
const ApproverAddMoreItemFormModal: FC<IProps> = props => {
...
export default React.memo(ApproverAddMoreItemFormModal);