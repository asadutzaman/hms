...
import UserListing from './UserList.listing'
import UserListPagination from './UserList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_bulk_confirm: 'Are you sure you wish to delete selected users?',
  },
}

const UserListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(UserApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <div className='listing-page-container listing-page-container-resource'>
        <Form form={formRef} name='resourceListingFilterForm' initialValues={initialValues}>
          <UserListFilter
            filters={filters}
