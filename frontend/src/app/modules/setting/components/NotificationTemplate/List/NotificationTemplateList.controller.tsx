...
import NotificationTemplateListFilter from './NotificationTemplateList.filter'
import NotificationTemplateListing from './NotificationTemplateList.listing'
import NotificationTemplateListPagination from './NotificationTemplateList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Notification Template successfully',
    delete_confirm_title: 'Delete Notification Template',
    delete_confirm: 'Are you sure you want to delete this Notification Template?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Notification Template(s)?',
  },
}

const NotificationTemplateListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(NotificationTemplateApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='notificationTemplateListingFilterForm' initialValues={initialValues}>
        <NotificationTemplateListFilter
          filters={filters}
          handleOnChanged={handleOnChanged}
          handleCallbackFunc={handleCallbackFunc}
        />
        <NotificationTemplateListing
          loading={loading}
          listData={listData}
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <NotificationTemplateListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <NotificationTemplateViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <NotificationTemplateFormController
        entityId={entityId}
...
export default NotificationTemplateListController
