...
import GoodsReceiveNoteListFilter from './GoodsReceiveNoteList.filter'
import GoodsReceiveNoteListing from './GoodsReceiveNoteList.listing'
import GoodsReceiveNoteListPagination from './GoodsReceiveNoteList.pagination'
...
const GoodsReceiveNoteListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(GoodsReceiveNoteApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='exampleListingFilterForm' initialValues={initialValues}>
        <GoodsReceiveNoteListFilter
          filters={filters}
          handleOnChanged={handleOnChanged}
          handleCallbackFunc={handleCallbackFunc}
        />
        <GoodsReceiveNoteListing
          loading={loading}
          listData={listData}
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <GoodsReceiveNoteListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <GoodsReceiveNoteViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <GoodsReceiveNoteFormController
        entityId={entityId}
...
export default GoodsReceiveNoteListController
