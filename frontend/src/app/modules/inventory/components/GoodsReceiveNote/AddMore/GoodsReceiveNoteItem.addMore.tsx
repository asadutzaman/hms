...
import GoodsReceiveNoteItemAddMoreItem from './GoodsReceiveNoteItem.addMore.item'
...
const GoodsReceiveNoteItemAddMore: FC<IProps> = (props) => {
    ...
    <table className='table table-bordered'>
      <thead>
        <tr>
          ...
          <th style={{width: '15%'}}>{t('Expire Date')}</th>
      ...
      <tbody>
        {addMoreItemList.length > 0 &&
          addMoreItemList.map((item: any, index: any) => (
            <GoodsReceiveNoteItemAddMoreItem
...
export default React.memo(GoodsReceiveNoteItemAddMore)
