...
import {RefreshIcon} from 'src/app/../_metronic/assets/images/icon/svg'
import SegmentedStep from 'src/app/components/Workflow/Segmented.step'
import {useLang} from 'src/app/hooks/useLang'

const PurchaseOrderApprovalListFilter: FC<any> = (props) => {
  const {Search} = Input
  const {
    handleOnChanged,
    handleCallbackFunc,
...
export default React.memo(PurchaseOrderApprovalListFilter)
