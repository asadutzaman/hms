...
import {PurchaseOrderApprovalAction} from '../Actions/PurchaseOrderApproval.actions'
import {useLang} from 'src/app/hooks/useLang'

const PurchaseOrderApprovalListing: FC<any> = (props) => {
  ...
  const columns = [
    {
      ...
      render: (text: string, record: any, index: number) => (
        <ViewAction
          entityId={record.id}
          actionItem={PurchaseOrderApprovalAction.COMMON_ACTION.VIEW}
    ...
    },
    {
      ...
      render: (text: string, record: any, index: number) => (
        <ListItemAction
          entity={record}
          entityId={record.id}
          actionList={PurchaseOrderApprovalAction.LIST_ITEM_ACTION}
          handleCallbackFunc={handleCallbackFunc}
  ...
  return (
    <div className='px-6'>
      <AntTable
        ...
        rowSelection={false}
        rowSelectionPermission='auth:purchaseOrderApproval:multiSelect'
...
export default React.memo(PurchaseOrderApprovalListing)
