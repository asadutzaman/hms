...
import PurchaseOrderApprovalViewTab from '../Tabs/PurchaseOrderApprovalView.tab'
import PurchaseOrderApprovalItemViewTab from '../Tabs/PurchaseOrderApprovalItemView.tab'
...
const PurchaseOrderApprovalView: FC<any> = (props) => {
  const {
    itemData,
    handleCallbackFunc,
    loading,
  ...
  const viewTabListData: any = [
    {
      ...
      permission: '',
      component: <PurchaseOrderApprovalViewTab itemData={itemData} />,
    },
    {
      tabIndex: 2,
      label: t('Purchase Order Items'),
      permission: '',
      component: <PurchaseOrderApprovalItemViewTab itemData={itemData} {...restProps} />,
    },
  ]
  return (
...
export default React.memo(PurchaseOrderApprovalView)
