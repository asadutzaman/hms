...
const RequisitionItemAddMoreItem: FC<any> = (props) => {
    const { Option } = Select;
        ...
        <tr>
            ...
            <td>
                <Form.Item className='mb-0'>
                    <InputNumber min={0} value={addMoreItem.request_quantity} onChange={(value) => handleAddMoreItemEdit('request_quantity', value, addMoreItemIndex)} style={{ width: '100%' }} />
                </Form.Item>                
            </td>
...
export default React.memo(RequisitionItemAddMoreItem);