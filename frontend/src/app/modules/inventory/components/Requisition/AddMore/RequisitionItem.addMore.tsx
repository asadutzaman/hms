...
import RequisitionItemAddMoreItem from './RequisitionItem.addMore.item';
...
const RequisitionItemAddMore: FC<IProps> = (props) => {
    ...
    <table className="table table-bordered">
      <thead>
        <tr>
          ...
          <th style={{ width: '60%' }}>{t('Product')}</th>
...
export default React.memo(RequisitionItemAddMore);
