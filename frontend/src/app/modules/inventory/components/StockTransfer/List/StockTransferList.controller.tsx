...
import StockTransferListFilter from './StockTransferList.filter'
import StockTransferListing from './StockTransferList.listing'
import StockTransferListPagination from './StockTransferList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_confirm_title: 'Delete StockTransfer',
...
const StockTransferListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(StockTransferApi, queryState, initialState, props)
    ...
    <div className='card'>
      <Form form={formRef} name='exampleListingFilterForm' initialValues={initialValues}>
        ...
        <StockTransferListing
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <StockTransferListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <StockTransferViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <StockTransferFormController
        entityId={entityId}
...
export default StockTransferListController
