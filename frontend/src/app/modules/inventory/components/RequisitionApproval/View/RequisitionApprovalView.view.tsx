...
// import WorkflowActionController from '../Workflow/Actions/WorkflowAction.controller'
// import WorkflowActivityTimeline from '../Workflow/Actions/WorkflowActivityTimeline'

const RequisitionApprovalView: FC<any> = (props) => {
  const {
    itemData,
    handleCallbackFunc,
    loading,
  ...
  const viewTabListData: any = [
    {
      tabIndex: 1,
      label: t('Requisition Approval Info'),
      permission: '',
      component: <RequisitionApprovalViewTab itemData={itemData} />,
    },
    {
      tabIndex: 2,
...
export default React.memo(RequisitionApprovalView)
