...
import RequisitionApprovalListFilter from './RequisitionApprovalList.filter'
import RequisitionApprovalListing from './RequisitionApprovalList.listing'
import RequisitionApprovalListPagination from './RequisitionApprovalList.pagination'
...
const initialState = {
  ...
  workflowInfo: {
    ...
    workflowName: 'Requisition Approval',
  },
  listData: [],
  filters: {
    status: '',
  ...
  message: {
    ...
    delete_success: 'Delete Requisition Approval successfully.',
    delete_confirm_title: 'Delete Requisition Approval',
    delete_confirm: 'Are you sure you want to delete this Requisition Approval?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Requisition Approval?',
  },
}

const RequisitionApprovalListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(RequisitionApprovalApi, queryState, initialState, props)
  ...
  const handleStepChange = (value: any) => {
    setActiveStep(value)
    handleOnChanged('workflow_step', value)
    ...
    <div className='card'>
      <Form form={formRef} name='exampleListingFilterForm' initialValues={initialValues}>
        ...
        <RequisitionApprovalListing
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <RequisitionApprovalListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <RequisitionApprovalViewController
        entityId={entityId}
...
export default RequisitionApprovalListController
