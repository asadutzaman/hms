...
const ItemConsumptionListFilter: FC<any> = (props) => {
  const { t } = useLang();
  const { Search } = Input;
  ...
  return (
    <div className="p-6">
      <Row gutter={[16, 16]}>
        ...
        <Col md={6} xs={12}>
          <CreateAction
            actionItem={ItemConsumptionAction.COMMON_ACTION.CREATE}
...
export default React.memo(ItemConsumptionListFilter);
