...
import StockTransferApprovalItemAddMoreItem from './StockTransferApprovalItem.addMore.item';
...
const StockTransferApprovalItemAddMore: FC<IProps> = (props) => {
      ...
      <tbody>
        {addMoreItemList.length > 0 &&
          addMoreItemList.map((item: any, index: any) => (
            <StockTransferApprovalItemAddMoreItem
...
export default React.memo(StockTransferApprovalItemAddMore);
