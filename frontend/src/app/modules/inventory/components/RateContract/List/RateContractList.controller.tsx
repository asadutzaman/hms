...
import RateContractListFilter from './RateContractList.filter'
import RateContractListing from './RateContractList.listing'
import RateContractListPagination from './RateContractList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Rate Contract deleted successfully.',
    delete_confirm_title: 'Delete Rate Contract',
    delete_confirm: 'Are you sure you want to delete this Rate Contract?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Rate Contracts?',
  },
}

const RateContractListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(RateContractApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='rateContractListingFilterForm' initialValues={initialValues}>
        <RateContractListFilter
          filters={filters}
        ...
        <RateContractListing
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <RateContractListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <RateContractViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <RateContractFormController
        entityId={entityId}
...
export default RateContractListController
