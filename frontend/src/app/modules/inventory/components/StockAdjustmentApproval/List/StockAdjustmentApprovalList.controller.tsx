...
import StockAdjustmentApprovalListFilter from './StockAdjustmentApprovalList.filter'
import StockAdjustmentApprovalListing from './StockAdjustmentApprovalList.listing'
import StockAdjustmentApprovalListPagination from './StockAdjustmentApprovalList.pagination'
...
import {StockAdjustmentApprovalApi} from 'src/app/api'
...
const initialState = {
  ...
  entityId: null,
  workflowInfo: {
    workflowType: 'StockAdjustment',
    workflowCode: 'STOCK_ADJUSTMENT_APPROVAL',
    workflowName: 'Stock Adjustment Approval',
  },
  listData: [],
  filters: {
    status: '',
...
const StockAdjustmentApprovalListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(StockAdjustmentApprovalApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='exampleListingFilterForm' initialValues={initialValues}>
        <StockAdjustmentApprovalListFilter
          filters={filters}
        ...
        />
        <StockAdjustmentApprovalListing
          loading={loading}
          listData={listData}
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <StockAdjustmentApprovalListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <StockAdjustmentApprovalViewController
        entityId={entityId}
...
export default StockAdjustmentApprovalListController
