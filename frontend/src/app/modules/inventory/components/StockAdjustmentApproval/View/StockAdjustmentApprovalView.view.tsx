...
import StockAdjustmentApprovalViewTab from '../Tabs/StockAdjustmentApprovalView.tab'
import StockAdjustmentApprovalItemViewTab from '../Tabs/StockAdjustmentApprovalItemView.tab'
...
const StockAdjustmentApprovalView: FC<any> = (props) => {
  const {
    itemData,
    handleCallbackFunc,
    loading,
  ...
  const viewTabListData: any = [
    {
      tabIndex: 1,
      label: t('Stock Adjustment Approval Info'),
      permission: '',
      component: <StockAdjustmentApprovalViewTab itemData={itemData} />,
    },
    {
      tabIndex: 2,
      label: t('Stock Adjustment Approval Items'),
      permission: '',
      component: <StockAdjustmentApprovalItemViewTab itemData={itemData} {...restProps} />,
    },
  ]
  return (
...
export default React.memo(StockAdjustmentApprovalView)
