...
const StockAdjustmentApprovalItemViewTab: FC<any> = (props) => {
      ...
      <table className='table table-bordered align-middle gs-1 gy-1'>
        ...
        <tbody>
          {itemData.stock_adjustment_items_list_data !== undefined &&
            itemData.stock_adjustment_items_list_data.map((localItem: any, localIndex: any) => (
...
export default React.memo(StockAdjustmentApprovalItemViewTab)
