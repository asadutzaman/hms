...
import GoodsReceiveNoteApprovalListFilter from './GoodsReceiveNoteApprovalList.filter'
import GoodsReceiveNoteApprovalListing from './GoodsReceiveNoteApprovalList.listing'
import GoodsReceiveNoteApprovalListPagination from './GoodsReceiveNoteApprovalList.pagination'
...
const initialState = {
  ...
  entityId: null,
  workflowInfo: {
    workflowType: 'GoodsReceiveNote',
    workflowCode: 'GOODS_RECEIVE_NOTE_APPROVAL',
    workflowName: 'Goods Receive Note Approval',
  },
  listData: [],
  filters: {
    status: '',
  ...
  message: {
    ...
    delete_success: 'Delete Goods Receive Note successfully.',
    delete_confirm_title: 'Delete Goods Receive Note',
    delete_confirm: 'Are you sure you want to delete this Goods Receive Note?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Goods Receive Note?',
  },
}

const GoodsReceiveNoteApprovalListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(GoodsReceiveNoteApprovalApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='exampleListingFilterForm' initialValues={initialValues}>
        <GoodsReceiveNoteApprovalListFilter
          filters={filters}
        ...
        />
        <GoodsReceiveNoteApprovalListing
          loading={loading}
          listData={listData}
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <GoodsReceiveNoteApprovalListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <GoodsReceiveNoteApprovalViewController
        entityId={entityId}
...
export default GoodsReceiveNoteApprovalListController
