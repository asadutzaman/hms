...
import GoodsReceiveNoteApprovalViewTab from '../Tabs/GoodsReceiveNoteApprovalView.tab'
import GoodsReceiveNoteApprovalItemViewTab from '../Tabs/GoodsReceiveNoteApprovalItemView.tab'
...
const GoodsReceiveNoteApprovalView: FC<any> = (props) => {
  const {
    itemData,
    handleCallbackFunc,
    loading,
  ...
  const viewTabListData: any = [
    {
      ...
      permission: '',
      component: <GoodsReceiveNoteApprovalViewTab itemData={itemData} />,
    },
    {
      tabIndex: 2,
      label: t('Goods Receive Note Items'),
      permission: '',
      component: <GoodsReceiveNoteApprovalItemViewTab itemData={itemData} {...restProps} />,
    },
  ]
  return (
...
export default React.memo(GoodsReceiveNoteApprovalView)
