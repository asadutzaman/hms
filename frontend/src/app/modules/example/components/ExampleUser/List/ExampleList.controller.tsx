...
import {FackApi} from 'src/app/api'
...
const initialState = {
  ...
  message: {
    ...
    delete_bulk_confirm: 'Are you sure you wish to delete selected examples?',
  },
}
...
const ExampleListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(FackApi, queryState, initialState, props)
