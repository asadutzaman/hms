...
import RadiologyTestListFilter from './RadiologyTestList.filter'
import RadiologyTestListing from './RadiologyTestList.listing'
import RadiologyTestListPagination from './RadiologyTestList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Radiology Test successfully',
    delete_confirm_title: 'Delete Radiology Test',
    delete_confirm: 'Are you sure you want to delete this Radiology Test?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Radiology Test(s)?',
  },
}

const RadiologyTestListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(RadiologyTestApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='radiologyTestListingFilterForm' initialValues={initialValues}>
        <RadiologyTestListFilter
          filters={filters}
          handleOnChanged={handleOnChanged}
          handleCallbackFunc={handleCallbackFunc}
        />
        <RadiologyTestListing
          loading={loading}
          listData={listData}
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <RadiologyTestListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <RadiologyTestViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <RadiologyTestFormController
        entityId={entityId}
...
export default RadiologyTestListController
