...
import RadiologyReportTemplateListFilter from './RadiologyReportTemplateList.filter'
import RadiologyReportTemplateListing from './RadiologyReportTemplateList.listing'
import RadiologyReportTemplateListPagination from './RadiologyReportTemplateList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Report Template successfully',
    delete_confirm_title: 'Delete Report Template',
    delete_confirm: 'Are you sure you want to delete this Report Template?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Report Template(s)?',
  },
}

const RadiologyReportTemplateListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(RadiologyReportTemplateApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='radiologyReportTemplateListingFilterForm' initialValues={initialValues}>
        <RadiologyReportTemplateListFilter
          filters={filters}
          handleOnChanged={handleOnChanged}
          handleCallbackFunc={handleCallbackFunc}
        />
        <RadiologyReportTemplateListing
          loading={loading}
          listData={listData}
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <RadiologyReportTemplateListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <RadiologyReportTemplateViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <RadiologyReportTemplateFormController
        entityId={entityId}
...
export default RadiologyReportTemplateListController
