...
const ItemRequisitionStatusListFilter: FC<any> = (props) => {
  const {Option} = Select
  ...
  return (
    <div className='p-6'>
      <Collapse defaultActiveKey={['1']}>
        <Panel header={t('DMP Unit Wise Requisition Statistics Filter')} key='1'>
          <Form
            layout='vertical'
            form={formRef}
            name='exampleForm'
          ...
          >
            <Row gutter={[16, 16]}>
              <Col span={6}>
                <Form.Item name='branch_id' label={t('DMP Unit')}>
                  <BranchSelect
...
export default React.memo(ItemRequisitionStatusListFilter)
