...
import RequisitionView from './RequisitionView.view'

const initialState = {
  modalTitle: 'Requisition Info',
  itemData: {},
  loading: false,
  fields: {},
  message: {
...
const RequisitionViewController: FC<any> = (props) => {
  const {
    BaseCrudViewService,
    modalTitle,
    itemData,
...
export default React.memo(RequisitionViewController)
