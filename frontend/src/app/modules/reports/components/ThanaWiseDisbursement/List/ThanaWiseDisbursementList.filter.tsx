...
const ThanaWiseDisbursementListFilter: FC<any> = (props) => {
  const { Option } = Select;
  ...
  return (
    <div className="p-6">
      <Collapse defaultActiveKey={['1']}>
        <Panel header={t('Thana Wise Disbursement Filter')} key="1">
          <Form
            layout="vertical"
            form={formRef}
            name="exampleForm"
            ...
            <Row gutter={[16, 16]}>
              <Col span={6}>
                ...
                >
                  ...
                  {/* REFEREMCE: STOCK TRANSFER - TRANSFER TO BRANCH SELECT */}
                  <BranchSelect
...
export default React.memo(ThanaWiseDisbursementListFilter);
