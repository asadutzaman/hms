...
import DisbursementView from './DisbursementView.view'
...
const DisbursementViewController: FC<any> = (props) => {
  const {
    modalTitle,
    itemData,
    loading,
    ...
    isShowView,
    handleCallbackFunc,
  } = useCrudViewService(RequisitionApi, initialState, props)
  ...
  }, [entityId, financialYear, reloadView])
  ...
  const loadData = (): Promise<any> => {
    return new Promise((resolve, reject) => {
      ...
      RequisitionApi.getItemDisbursementDetails(params)
        .then((res: any) => {
...
export default React.memo(DisbursementViewController)
