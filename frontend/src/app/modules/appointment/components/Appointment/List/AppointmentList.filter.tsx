...
const AppointmentListFilter: FC<any> = (props) => {
  const {Search} = Input
  const {Option} = Select
  ...
  return (
    <div className='p-6'>
      <Row gutter={[16, 16]}>
        ...
        <Col md={6} xs={12}>
          <CreateAction
            actionItem={AppointmentAction.COMMON_ACTION.CREATE}
      ...
      <Row gutter={[16, 16]}>
        <Col md={4} xs={12}>
          <Form.Item name='search'>
            <Search
              placeholder='Search by appointment #, patient name or phone'
        ...
        <Col md={3} xs={12}>
          <Form.Item name='appointment_date_range' label='Date'>
            <RangePicker
        ...
        <Col md={2} xs={12}>
          <div className='d-flex justify-content-end'>
            ...
            <BulkAction
              bulkAction={AppointmentAction.BULK_ACTION}
              handleCallbackFunc={handleCallbackFunc}
            />
          </div>
        </Col>
...
export default React.memo(AppointmentListFilter)
