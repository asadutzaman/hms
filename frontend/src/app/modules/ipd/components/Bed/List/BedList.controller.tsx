...
import BedListFilter from './BedList.filter';
import BedListing from './BedList.listing';
import BedListPagination from './BedList.pagination';
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Bed successfully',
    delete_confirm_title: 'Delete Bed',
    delete_confirm: 'Are you sure you want to delete this Bed?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Bed?',
  },
};

const BedListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(BedApi, queryState, initialState, props);
...
export default BedListController;
