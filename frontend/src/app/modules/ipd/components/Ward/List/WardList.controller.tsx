...
import WardListFilter from './WardList.filter';
import WardListing from './WardList.listing';
import WardListPagination from './WardList.pagination';
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Ward successfully',
    delete_confirm_title: 'Delete Ward',
    delete_confirm: 'Are you sure you want to delete this Ward?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Ward?',
  },
};

const WardListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(WardApi, queryState, initialState, props);
...
export default WardListController;
