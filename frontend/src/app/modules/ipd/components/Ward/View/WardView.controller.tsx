...
import WardView from './WardView.view'

const initialState = {
  modalTitle: 'Ward Info',
  itemData: {},
  loading: false,
  fields: {},
  message: {
...
const WardViewController: FC<any> = (props) => {
  const {
    BaseCrudViewService,
    modalTitle,
    itemData,
    ...
    isShowView,
    handleCallbackFunc,
  } = useCrudViewService(WardApi, initialState, props)
...
export default React.memo(WardViewController)
