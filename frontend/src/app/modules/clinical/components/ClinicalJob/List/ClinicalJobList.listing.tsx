...
const ClinicalJobListing: FC<any> = (props) => {
  ...
  const columns = [
    ...
    {
      dataIndex: 'priority', key: 'priority', title: 'Priority', sorter: true, width: '15%',
    },
    {
      dataIndex: 'role_type', key: 'role_type', title: 'Role', sorter: true, width: '15%',
    },
    {
      dataIndex: 'state', key: 'state', title: 'State', sorter: true, width: '15%',
    },
    {
  ...
  return (
    <div className='px-6'>
      <AntTable className='table-layout' rowSelection={false} scroll={{y: 500}} rowSelectionPermission='hms:clinical-job:multiSelect'
...
export default React.memo(ClinicalJobListing)
