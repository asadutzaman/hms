...
const ClinicalJobView: FC<any> = (props) => {
    ...
    <div className='card card-body position-relative'>
      ...
      <div className='table-responsive'>
        <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
          <tr>
            <td width='25%'>Title</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.title ?? '')}</td>
          </tr>
          <tr>
            <td width='25%'>Type</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.job_type ?? '')}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td width='25%'>Due At</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.due_at ?? '')}</td>
          </tr>
          <tr>
            <td width='25%'>Description</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.description ?? '')}</td>
          </tr>
          <tr>
...
export default React.memo(ClinicalJobView)
