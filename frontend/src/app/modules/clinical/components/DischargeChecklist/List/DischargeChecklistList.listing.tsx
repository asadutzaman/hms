...
const DischargeChecklistListing: FC<any> = (props) => {
  ...
  return (
    <div className='px-6'>
      <AntTable className='table-layout' rowSelection={false} scroll={{y: 500}} rowSelectionPermission='hms:discharge-checklist:multiSelect'
...
export default React.memo(DischargeChecklistListing)
