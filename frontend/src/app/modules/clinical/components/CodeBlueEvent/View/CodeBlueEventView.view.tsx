...
const CodeBlueEventView: FC<any> = (props) => {
    ...
    <div className='card card-body position-relative'>
      ...
      <div className='table-responsive'>
        <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
          <tr>
            <td width='25%'>Event Type</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.event_type ?? '')}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td width='25%'>Location</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.location ?? '')}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td width='25%'>Severity</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.severity ?? '')}</td>
          </tr>
          <tr>
            <td width='25%'>Reason</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.reason ?? '')}</td>
          </tr>
          <tr>
...
export default React.memo(CodeBlueEventView)
