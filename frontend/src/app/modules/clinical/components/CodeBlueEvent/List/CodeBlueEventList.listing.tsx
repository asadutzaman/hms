...
const CodeBlueEventListing: FC<any> = (props) => {
  ...
  const columns = [
    ...
    {
      dataIndex: 'location', key: 'location', title: 'Location', sorter: true, width: '15%',
    },
    {
  ...
  return (
    <div className='px-6'>
      <AntTable className='table-layout' rowSelection={false} scroll={{y: 500}} rowSelectionPermission='hms:code-blue-event:multiSelect'
...
export default React.memo(CodeBlueEventListing)
