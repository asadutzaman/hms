...
const AtoeAssessmentListing: FC<any> = (props) => {
  ...
  const columns = [
    ...
    {
      dataIndex: 'news2_score', key: 'news2_score', title: 'NEWS2', sorter: true, width: '15%',
    },
    {
      dataIndex: 'impression', key: 'impression', title: 'Impression', sorter: true, width: '15%',
    },
    {
  ...
  return (
    <div className='px-6'>
      <AntTable className='table-layout' rowSelection={false} scroll={{y: 500}} rowSelectionPermission='hms:atoe-assessment:multiSelect'
...
export default React.memo(AtoeAssessmentListing)
