...
const BleepListing: FC<any> = (props) => {
  ...
  const columns = [
    ...
    {
      dataIndex: 'callback', key: 'callback', title: 'Callback', sorter: true, width: '15%',
    },
    {
  ...
  return (
    <div className='px-6'>
      <AntTable className='table-layout' rowSelection={false} scroll={{y: 500}} rowSelectionPermission='hms:bleep:multiSelect'
...
export default React.memo(BleepListing)
