...
const BleepViewController: FC<any> = (props) => {
  ...
  return (
    <DrawerView loading={loading} reloadView={reloadView} isShowView={isShowView} modalTitle={modalTitle}
      itemData={itemData} component={BleepView} handleCallbackFunc={handleCallbackFunc} />
  )
}
export default React.memo(BleepViewController)
