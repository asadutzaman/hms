...
const SoapNoteAddOrEditForm: FC<any> = (props) => {
  const {Option} = Select
  ...
  return (
    <Fragment>
      <div className='form-page-content pe-3'>
        <Form {...formItemLayout} layout='vertical' form={formRef} name='soap-notesForm' scrollToFirstError={true}
...
export default React.memo(SoapNoteAddOrEditForm)
