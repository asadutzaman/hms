...
const SoapNoteListing: FC<any> = (props) => {
  ...
  const columns = [
    ...
    {
      dataIndex: 'assessment', key: 'assessment', title: 'Assessment', sorter: true, width: '15%',
    },
    {
  ...
  return (
    <div className='px-6'>
      <AntTable className='table-layout' rowSelection={false} scroll={{y: 500}} rowSelectionPermission='hms:soap-note:multiSelect'
...
export default React.memo(SoapNoteListing)
