...
const OrderSetListing: FC<any> = (props) => {
  ...
  const columns = [
    ...
    {
      dataIndex: 'category', key: 'category', title: 'Category', sorter: true, width: '15%',
    },
    {
  ...
  return (
    <div className='px-6'>
      <AntTable className='table-layout' rowSelection={false} scroll={{y: 500}} rowSelectionPermission='hms:order-set:multiSelect'
...
export default React.memo(OrderSetListing)
