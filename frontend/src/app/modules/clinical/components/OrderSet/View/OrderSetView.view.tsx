...
const OrderSetView: FC<any> = (props) => {
    ...
    <div className='card card-body position-relative'>
      ...
      <div className='table-responsive'>
        <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
          <tr>
            <td width='25%'>Name</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.name ?? '')}</td>
          </tr>
          <tr>
            <td width='25%'>Category</td><td width='5%'>:</td>
            <td width='70%'>{String(itemData.category ?? '')}</td>
          </tr>
          <tr>
...
export default React.memo(OrderSetView)
