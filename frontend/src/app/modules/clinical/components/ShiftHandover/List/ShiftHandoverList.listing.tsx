...
const ShiftHandoverListing: FC<any> = (props) => {
  ...
  const columns = [
    ...
    {
      dataIndex: 'shift_label', key: 'shift_label', title: 'Shift', sorter: true, width: '15%',
    },
    {
      dataIndex: 'summary', key: 'summary', title: 'Summary', sorter: true, width: '15%',
    },
    {
  ...
  return (
    <div className='px-6'>
      <AntTable className='table-layout' rowSelection={false} scroll={{y: 500}} rowSelectionPermission='hms:shift-handover:multiSelect'
...
export default React.memo(ShiftHandoverListing)
