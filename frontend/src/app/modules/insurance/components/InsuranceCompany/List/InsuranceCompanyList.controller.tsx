...
import InsuranceCompanyListFilter from './InsuranceCompanyList.filter'
import InsuranceCompanyListing from './InsuranceCompanyList.listing'
import InsuranceCompanyListPagination from './InsuranceCompanyList.pagination'
...
const initialState = {
  ...
  message: {
    ...
    delete_success: 'Delete Insurance Company successfully',
    delete_confirm_title: 'Delete Insurance Company',
    delete_confirm: 'Are you sure you want to delete this Insurance Company?',
    delete_bulk_select: 'Please select item(s)',
    delete_bulk_confirm: 'Are you sure you wish to delete selected Insurance Company(ies)?',
  },
}

const InsuranceCompanyListController: FC<any> = (props) => {
  ...
  const {
    ...
    reloadView,
    reloadForm,
  } = useCrudListService(InsuranceCompanyApi, queryState, initialState, props)
  ...
  return (
    <div className='card'>
      <Form form={formRef} name='insuranceCompanyListingFilterForm' initialValues={initialValues}>
        <InsuranceCompanyListFilter
          filters={filters}
          handleOnChanged={handleOnChanged}
          handleCallbackFunc={handleCallbackFunc}
        />
        <InsuranceCompanyListing
          loading={loading}
          listData={listData}
          ...
          handleCallbackFunc={handleCallbackFunc}
        />
        <InsuranceCompanyListPagination
          pagination={pagination}
          totalCount={totalCount}
          handleOnChanged={handleOnChanged}
        />
      </Form>
      <InsuranceCompanyViewController
        entityId={entityId}
        reloadView={reloadView}
        isShowView={isShowView}
        handleCallbackFunc={handleCallbackFunc}
      />
      <InsuranceCompanyFormController
        entityId={entityId}
...
export default InsuranceCompanyListController
