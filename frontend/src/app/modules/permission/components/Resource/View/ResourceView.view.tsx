...
const ResourceView: FC<any> = (props) => {
    ...
    <div className="card card-body position-relative">
      <div className="row mb-7">
        <div className="col-lg-12">
          <EditAction
            ...
            actionItem={ResourceAction.COMMON_ACTION.EDIT}
            handleCallbackFunc={handleCallbackFunc}
          />
          <DeleteAction
            entityId={itemData.id}
            actionItem={ResourceAction.COMMON_ACTION.DELETE}
            handleCallbackFunc={handleCallbackFunc}
          />
        </div>
      </div>
      <div className="table-responsive">
        <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
          <tr>
            <td width={'20%'}>{t('Permission Type')}</td>
            <td width={'5%'}>:</td>
            <td width={'75%'}>{itemData.permission_type}</td>
          </tr>
          <tr>
            <td width={'20%'}>{t('Resource Name (ID)')}</td>
            <td width={'5%'}>:</td>
          ...
          <tr>
            <td width={'20%'}>{t('Resource URI')}</td>
            <td width={'5%'}>:</td>
            <td width={'75%'}>{itemData.resource_uri}</td>
          </tr>
          <tr>
            <td width={'20%'}>{t('Controller Name')}</td>
            <td width={'5%'}>:</td>
            <td width={'75%'}>{itemData.controller_name}</td>
          </tr>
          <tr>
            <td width={'20%'}>{t('Resource URI')}</td>
            <td width={'5%'}>:</td>
