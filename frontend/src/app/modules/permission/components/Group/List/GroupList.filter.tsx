...
const GroupListFilter: FC<any> = (props) => {
  const {Search} = Input
  const {Option} = Select
  ...
  return (
    <div className='p-6'>
      <Row gutter={[16, 16]}>
        ...
        <Col md={6} xs={12}>
          <CreateAction
            actionItem={GroupAction.COMMON_ACTION.CREATE}
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col md={4} xs={12}>
          <div className='d-flex justify-content-end'>
            ...
            <BulkAction
              bulkAction={GroupAction.BULK_ACTION}
              handleCallbackFunc={handleCallbackFunc}
            />
          </div>
        </Col>
...
export default React.memo(GroupListFilter)
