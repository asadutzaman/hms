...
import DelegateActionForm from './DelegateAction.form'
...
const DelegateActionController: FC<any> = (props) => {
  const {
    entityId,
    workflowLoading,
    workflowData,
...
export default React.memo(DelegateActionController)
